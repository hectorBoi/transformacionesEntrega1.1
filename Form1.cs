...
namespace transformacionesEntrega1._1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            InitializeComponent();
            Init();
            locationX = new int[MAX_COUNTER];
            locationY = new int[MAX_COUNTER];
            movements = new string[MAX_COUNTER];
            counter = 0;
            //timer = new System.Windows.Forms.Timer();
            TIMER2.Interval = TIME_INTERVAL;
        ...
        public void TIMER2_Tick(object sender, EventArgs e)
        {
            ...
            {
                locationX[counter] = Cursor.Position.X;
                locationY[counter] = Cursor.Position.Y;
                movements[counter] = "Movement " + counter;
                counter++;
            }
            else
            {
